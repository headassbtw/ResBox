...
pub fn page_header(ui: &mut egui::Ui, header: &str, subheader: &str) -> Response{
    ...
    painter.text(header_pos, Align2::LEFT_TOP, header, FontId::proportional(30.0), Color32::WHITE);
    painter.text(subheader_pos, Align2::LEFT_TOP, subheader, FontId::proportional(20.0), Color32::from_gray(140));
    response
}